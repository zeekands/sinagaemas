            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => Ormas()));
              },
            ),
            IconButton(
              icon: const Icon(
          ...
          : SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16.0),
                  Text('Nama Singkat Ormas : ${dataOrmas.namaSingkatOrmas}'),
                  const SizedBox(height: 16.0),
                  Text('Alamat Sekretariat : ${dataOrmas.alamatSekretariat}'),
                  const SizedBox(height: 16.0),
